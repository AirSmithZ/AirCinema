...
import { formatSeconds ,getMaxdata } from '../utils/tools';
...
class VideoPlayer extends React.Component {
    ...
    constructor(props) {
        super(props)
        console.log(props.route.params.watchItem.media,'-=---------')
        this.noVipSecond = this.props.noVipSecond || 5//没有vip可观看的分钟数
        this.url = this.props.route.params.watchItem.media
    ...
    animatedonBuffer(event) {
        ...
        this.setState({
            showLoading:  (!this.state.paused && true)
        })
    }
