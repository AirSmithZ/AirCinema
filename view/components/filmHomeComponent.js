              ...
              <View height={150}>
                  ...
                  >
                      ...
                      <View style={styles.slide3}>
                          <Text style={styles.text}>And Blank</Text>
                      </View>
                  </Swiper>
              </View>
              {
                mapList.map(item=>{
                    return item.showID === 'wu' ? (
                        <MediaList teleplayList={movieList} showID={item.showID} listName={item.listName} curState={item.curState} navigation={navigation} key={item.showID}/>
                    ):(
                        <MediaList teleplayList={teleplayList} showID={item.showID} listName={item.listName} curState={item.curState} navigation={navigation} key={item.showID}/>
                    )
                })
              }
